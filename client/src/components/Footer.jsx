...
export const Footer = () => (
  <Box w='100%' bg={useColorModeValue("gray.100", "gray.900")}>
    <Container as='footer' role='contentinfo' maxW='7x1'>
      <Stack
        spacing='8'
      ...
      >
        <Stack spacing={{ base: "6", md: "8" }} align='start'>
          <Flex alignItems='center'>
            <Icon as={BiBookHeart} h={10} w={10} color={useColorModeValue("orange.400", "orange.600")}></Icon>
            <Text fontSize='2x2'>WRITAD</Text>
          </Flex>
          <Text color='muted'>Unlock Endless Adventures at Affordable Prices</Text>
        </Stack>
      ...
      <Stack pt='8' pb='12' justify='space-between' direction={{ base: "column-reverse", md: "row" }} align='center'>
        <Text fontSize='sm' color='subtle'>
          &copy; {new Date().getFullYear()} Writad, Inc. All rights reserved.
        </Text>
