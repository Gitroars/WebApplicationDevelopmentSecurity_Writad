import { Box,Button,FormControl,Heading,HStack,Stack,Text,Alert,AlertIcon,AlertTitle,AlertDescription,Flex,Card,CardHeader,CardBody,StackDivider, useToast, StepTitle} from "@chakra-ui/react"
...
const ProfileScreen=()=>{
    ...
    {(formik)=>(<Box 
    minH='100vh' maxW={{base:'3x1',lg:'7x1'}}
    ...
    py={{base:'4',md:'8',lg:'12'}}>
        <Stack spacing='10' direction={{base:'column',lg:'row'}} align={{lg:'flex-start'}}>
            <Stack flex='1.5' mb={{base:'2x1',md:'none'}}>
                <Heading fontSize='2x1' fontWeight='extrabold'>Profile</Heading>
                <Stack spacing='6'>
                ...
                <Stack spacing='5'>
                    <FormControl>
                        <TextField type='text' name='name' placeholder="Your first and last name" label='full name'></TextField>
                ...
                <Stack spacing='6'>
                    <Button colorScheme='orange' size='lg' isLoading={loading} type='submit'>Save</Button>
                </Stack>
                </Stack>
            </Stack>
